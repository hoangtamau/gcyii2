...
class LaytheController extends \yii\web\Controller
{
    ...
    public function actionThanhtien() {        
        ...
        if ($request->get()) {
            ...
            echo "<input type='text' name='tt' value='".Globals::formatprice($total)." ".$notation."' />:<input type='hidden' value='".$price."' id='hiddenprice' />:<input type='hidden' value='".$item_id."' id='idthe1' />:<input type='hidden' value='".$item['title']."' id='namethe1' />";
        }
    }
    public function actionAdd() {        
        ...
        return $this->redirect(["/mua-the.html"]);
