...
class UserHistoryMoney extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['money_send', 'currency_send', 'payment_method', 'currency_payment_method', 'date', 'uid', 'status', 'fee_send', 'money_payment_method', 'total_payment_method'], 'required'],
            [['money_send', 'fee_send', 'money_payment_method', 'total_payment_method'], 'number'],
            [['date', 'uid', 'rounding'], 'integer'],
            [['data'], 'string'],
