...
class RepaymoneyController extends \yii\web\Controller {
    ...
    public function actionOnecomnd() {
        ...
        if (isset($_GET["vpc_SecureHash"]) && isset($_GET["vpc_MerchTxnRef"])) {
            ...
            /*$array_merchtxnref[1]; 
            $updateorrder= UserHistoryMoney::find()->where('id='.$array_merchtxnref[1])->one();
            $updateorrder->data=$querystring;
            $updateorrder->save(); die();*/
            ...
            if (count($array_merchtxnref) == 3 && $array_merchtxnref[0] == 'Order' && is_numeric($array_merchtxnref[1]) && is_numeric($array_merchtxnref[2])) {
                ...
                if ($hashValidated == "CORRECT" && $txnResponseCode == "0") {
                    ...
                    $html .='<p style="font-size:13px;font-weight:bold;line-height:31px; text-align:center; ">Cám ơn quý khách, quá trình thanh toán đã được hoàn tất !
                    ...
                    $html.='<p style="font-size:13px;font-weight:bold;line-height:31px; text-align:center; ">Quá trình thanh toán không thành công bạn vui lòng thực hiện lại !
                            <br><a style="color:red;" href="' . Yii::$app->getHomeUrl() . '"> Trở lại trang chủ</a></p>';
                } elseif ($hashValidated == "INVALID HASH") {
                    $status_oncome = 'pending';
                    $html.='<p style="font-size:13px;font-weight:bold;line-height:31px; text-align:center; ">Quá trình thanh toán đang trong trạng thái chờ 
                            <br><a style="color:red;" href="' . Yii::$app->getHomeUrl() . '">Trở lại trang chủ</a>.</p>';
    ...
    public function actionPaypalcancel() {         
        $html.='<p style="font-size:13px;font-weight:bold;line-height:31px; text-align:center; ">
